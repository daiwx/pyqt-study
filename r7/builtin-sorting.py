...
class Example(QtGui.QWidget):
    ...
    def initUI(self):
        ...
        sortB.setSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
    ...
    def sortItems(self):
        ...
        if checked:
            self.tv.sortByColumn(FIRST_COLUMN, QtCore.Qt.AscendingOrder)
        else:
            self.tv.sortByColumn(FIRST_COLUMN, QtCore.Qt.DescendingOrder)
